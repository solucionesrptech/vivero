...
import { CartDomainError, type CartDomainErrorKind } from '../bll/cart.domain-error';
...
const CART_DOMAIN_HTTP_STATUS: Record<CartDomainErrorKind, number> = {
  ...
  INVALID_CHECKOUT: HttpStatus.BAD_REQUEST,
  CHECKOUT_FAILED: HttpStatus.SERVICE_UNAVAILABLE,
