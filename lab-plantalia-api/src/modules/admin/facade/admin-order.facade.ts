...
import { orderAllowedNextStatuses } from '../bll/admin-order.transitions';
...
export class AdminOrderFacade {
  ...
  async patchStatus(
    ...
    if (sendCustomerReadySms) {
      // Side effect de orquestación: la regla vive en BLL y la notificación se dispara desde Facade.
      const finalStatus =
